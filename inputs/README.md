...
| `dcp_decennial_census_2020.xlsx` | NYC Department of City Planning, Decennial Census 2020 core geographies workbook (sheet `2020`; columns `GeoType`, `GeoID`, `Pop1` total population, `BNH` Black non-Hispanic, `Hsp1` Hispanic of any race) | https://www.nyc.gov/site/planning/data-maps/nyc-population/2020-census.page | 2026-08-21 |
