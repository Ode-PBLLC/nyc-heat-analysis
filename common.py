...
SOURCES = {
    "hvi": "NYC Department of Health and Mental Hygiene, Heat Vulnerability Index by 2020 Neighborhood Tabulation Area, Environment & Health Data Portal, https://a816-dohbesp.nyc.gov/IndicatorPublic/data-features/hvi/ (retrieved 2026-08-21). Construction per DOHMH: the index sums five factors (median household income, percent vegetative cover, percent of population Non-Hispanic Black on Census 2020, average surface temperature, percent of households with air conditioning access) and assigns neighborhoods to quintiles scored 1 to 5; NYC Open Data, Heat Vulnerability Index Rankings, dataset 4mhf-duep, https://data.cityofnewyork.us/d/4mhf-duep, and indicator 2411 description, https://a816-dohbesp.nyc.gov/IndicatorPublic/data-explorer/climate/?id=2411#display=summary (both checked 2026-09-16)",
